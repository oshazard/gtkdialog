...
A [GtkCombo](http://developer.gnome.org/gtk2/2.24/GtkCombo.html)
...
See the [GtkCombo](http://developer.gnome.org/gtk2/2.24/GtkCombo.html#GtkCombo.object-hierarchy) widget and ancestor class properties.
...
This widget has been deprecated since GTK+ 2.4 and [comboboxtext](comboboxtext.md) or [comboboxentry](comboboxentry.md) are recommended as replacements.
