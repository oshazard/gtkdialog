...
A [GtkFontButton](http://developer.gnome.org/gtk2/2.24/GtkFontButton.html)
...
See the [GtkFontButton](http://developer.gnome.org/gtk2/2.24/GtkFontButton.html#GtkFontButton.object-hierarchy) widget and ancestor class properties.
...
|:---------|:----------------|:-------------|:----------|
| default  | Initial data    | Font name    |           |
...
The default signal is "[font-set](http://developer.gnome.org/gtk2/2.24/GtkFontButton.html#GtkFontButton-font-set)", emitted when the user selects a font.
