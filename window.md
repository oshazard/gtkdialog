...
A [GtkWindow](http://developer.gnome.org/gtk2/2.24/GtkWindow.html)
...
See the [GtkWindow](http://developer.gnome.org/gtk2/2.24/GtkWindow.html#GtkWindow.object-hierarchy) widget and ancestor class properties.
...
| refresh  | Reload input data<sup>[1]</sup> | Variable name | 0.8.1     |
...
This widget has a default border width of 5 which can be overridden with the "[border-width](http://developer.gnome.org/gtk2/2.24/GtkContainer.html#GtkContainer--border-width)" tag attribute.
